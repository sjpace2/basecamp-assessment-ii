...
// CODE HERE
var me = {firstname:"Stephen",age:33,state:"Utah"};
...
// CODE HERE
var myFriends = ["Grant","Russell","Wesley","Kristen"];

// #6 Add a fifth friends name to the end of your myFriends array

// CODE HERE
myFriends.push("Jeffrey");
...
function evensOnly() {
  // CODE HERE
    var evensArray=[];
    myNumbers.map(function(element){
    if (element%2===0){
...
var peopleIknow = [
 ...
 var trueFriends=peopleIknow.filter(function(e,i,arr){
  if(e.friend===true){
   return e.name
  }
})
